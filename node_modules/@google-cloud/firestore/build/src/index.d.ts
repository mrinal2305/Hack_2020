...
export declare class Firestore {
    ...
    _runTransaction<T>(updateFunction: (transaction: Transaction) => Promise<T>, transactionOptions: {
        requestTag: string;
     ...
     * });
     */
    getAll(...documentRefsOrReadOptions: Array<DocumentReference | ReadOptions>): Promise<DocumentSnapshot[]>;
    /**
     ...
     */
    getAll_(docRefs: DocumentReference[], fieldMask: FieldPath[] | null, requestTag: string, transactionId?: Uint8Array): Promise<DocumentSnapshot[]>;
    /**
